...
const SkillBox = ({ src, alt, title }) => {
    return (
        <div className='text-neutral-700 flex items-center rounded-md shadow-md shadow-indigo-300'>
            <div className='bg-neutral-200 w-16 h-16 rounded-l-md flex items-center justify-center overflow-hidden'>
                <Image
                    src={src}
                    alt={alt}
                    width={64}
            ...
            <div className='rounded-r-md bg-neutral-300 h-16 w-full flex items-center justify-center px-4'>
